...
**Last updated:** 2026-08-02 · **Updated by:** Principal Engineer review — E6-F1-T2 implemented (dead `queue.service.ts` stub deleted). E5-F1-T1, E1-F2-T2, E4-F2-T1 all require architecture/API decisions and are pending sign-off, not implemented.
