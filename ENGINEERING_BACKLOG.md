...
**Last updated:** 2026-08-02 · **Updated by:** Principal Engineer review — E6-F2-T2 implemented (magic-number extraction, `constants/timing.ts`); E8-F2-T1 and E4-F3-T1 require architecture/business decisions and were presented + not implemented.
