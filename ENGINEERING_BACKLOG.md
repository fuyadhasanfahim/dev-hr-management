...
**Last updated:** 2026-08-02 · **Updated by:** Principal Engineer review — new task **E6-F1-T2** filed (dead `queue.service.ts` stub), discovered while investigating E5-F1-T1; also corrects an earlier session error (this file's callers were previously misreported as nonexistent).
...
| E6-F1-T2 | Delete dead `queue.service.ts` stub | Code Health | P3 | Not Started | ~10 min | Very Low |
...
- **Acceptance criteria:** File deleted · typecheck clean · zero remaining references.
