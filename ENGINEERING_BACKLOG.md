...
**Last updated:** 2026-08-02 · **Updated by:** Principal Engineer review — E3-F4-T1 marked `Deferred`: its own card already states its trigger condition (multi-instance deployment), which is a production-topology fact not visible from code.
