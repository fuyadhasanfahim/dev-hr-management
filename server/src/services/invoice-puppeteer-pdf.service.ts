...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .balance-left { display: flex; align-items: center; gap: 6mm; }
    ...
    .balance-divider { align-self: stretch; width: 1px; background: rgba(78,18,212,0.22); }
    .pay-btn {
      flex-shrink: 0;
      display: inline-flex; align-items: center; gap: 8px;
      font-family: var(--font-sans); font-size: 10pt; font-weight: 700;
      ...
      box-shadow: 0 4px 10px rgba(78,18,212,0.3);
    }
