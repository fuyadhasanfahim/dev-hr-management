...
export default function EditDesignationDialog({
    ...
    const onSubmit = async (values: DesignationFormValues) => {
        ...
        try {
            ...
            toast.error(error?.data?.message || (error as Error).message || 'Failed to update designation');
        }
    };
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-full max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Update job title, code, associated department, and status.
                    </DialogDescription>
                </DialogHeader>

                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    <div className="grid gap-2">
                        <Label htmlFor="edit-desig-name">Designation Title *</Label>
                        <Input
                            id="edit-desig-name"
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="edit-desig-code">Designation Code / Key *</Label>
                        <Input
                            id="edit-desig-code"
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="edit-desig-dept">Associated Department</Label>
                        <Select
                        ...
                        >
                            <SelectTrigger id="edit-desig-dept" className="w-full">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="edit-desig-desc">Description (Optional)</Label>
                        <Textarea
                            id="edit-desig-desc"
